...
st.set_page_config(
    page_title="Personal Library Manager By Sameed Siddiqui ✅",
    page_icon="📚",
    layout="wide",
...
def load_library():
    try:
        ...
        st.error(f"Error Loading In Library: {e}")
        return False
...
def save_library():
    try:
        ...
        st.error(f"Error Saving In Library: {e}")
        return False
...
if st.session_state.current_view == "add":
    ...
    with st.form(key='add_book_form'):
        ...
        with col1 :
            ...
            publication_year = st.number_input("publication year", min_value=1000, max_value = datetime.now().year ,step =1,value=2025)

        with col2 :
            genre = st.selectbox("Genre" , [
                "Fiction", "Non-Fiction", "Science", "Technology", "Fantasy", 
                "Romance", "Poetry", "Self-help", "Art", "Religion",
                "Biography", "History", "Mystery", "Thriller", "Horror",
                "Science Fiction", "Young Adult", "Children's", "Cooking",
                "Travel", "Health", "Psychology", "Philosophy", "Business",
                "Economics", "Politics", "True Crime", "Humor", "Drama",
                "Classics", "Contemporary", "Literary Fiction", "Historical Fiction",
                "Adventure", "Crime", "Western", "Paranormal", "Graphic Novel",
                "Short Stories", "Essays", "Memoir", "Autobiograph"
            ])
            read_status = st.radio("Read Status", ["Read" ,"Unread"],horizontal=True)
            read_bool = read_status == "Read"
        submit_button = st.form_submit_button(label="Add Book")

        if submit_button and author:
    ...
    search_by = st.selectbox("Seacrh By:" , ["Title" , "Author" ,"Genre"])
...
st.markdown("---")
st.markdown("© 2025 Sameed Siddiqui Personal Library Manager | Created with Love and Streamlit", unsafe_allow_html=True)
